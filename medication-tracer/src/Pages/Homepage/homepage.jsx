    ...
    <div>
        ...
        <nav className='navbar'>
            ...
            <ul>
                ...
                <li><a href="#"> <botton type="submit" className="item-container-1" > Log In </botton></a></li>
            </ul>
        </nav>
      ...
      <div className='Vision'>
          <h1 className='intro-description'>MediTracer's Objectives</h1>
          <div className="cards">
            ...
            <h1 className='card-head'>
              ...
              <p className='card-text'>
              Meditracer dreams of a tomorrow where healthcare transcends barriers, embracing seamless integration, personalization, and universal accessibility. Our  is a catalyst, empowering every individual and healthcare professional to forge pathways toward enhanced well-being and unprecedented health outcomes.
              </p>          
            </div>
          </div>
      </div>
    ...
    <div className="download">
      <div >
        ...
        <p className="download-para-text">
            Revolutionize your task management. Achieve your goal, one task <br/> at a time. Grab your download and get stand
        </p>
        <a href="#"> <botton type="submit" className="item-container-1" >Sign Up</botton></a>
      </div>
    </div>
